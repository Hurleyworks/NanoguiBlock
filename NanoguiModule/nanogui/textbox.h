...
class  TxtBox : public Widget
{
   public:
      ...
      bool mouseButtonEvent (const ivec2 & p, int button, bool down, int modifiers);
      bool mouseMotionEvent (const ivec2 & p, const ivec2 & rel, int button, int modifiers);
      bool mouseDragEvent (const ivec2 & p, const ivec2 & rel, int button, int modifiers);
      bool mouseEnterEvent (const ivec2 & p, bool enter);
      bool focusEvent (bool focused);
      bool keyboardEvent (int key, int scancode, int action, int modifiers);
      bool keyboardCharacterEvent (unsigned int codepoint);

      ivec2 preferredSize (NVGcontext * ctx) const;
